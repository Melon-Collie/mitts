...
- **Pending netcode work:** session-relative timestamps for long-session f32 precision (`docs/netcode-improvements-plan.md` #4); adaptive broadcast rate during dead-puck phases. (WorldStateCodec goalie decode bounds check — done.)
