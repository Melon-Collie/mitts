...
- **Passive shot blocking not yet implemented:** skater bodies are on `LAYER_SKATER_BODIES` (16) and puck mask is `LAYER_WALLS` (1), so puck passes through skater bodies. Deliberate body-block mechanic is planned.
