...
**Rates:** inputs 60 Hz unreliable (client → host), batched as last 12 physics frames per packet for redundancy; world state 40 Hz unreliable (host → clients); events reliable RPCs.
