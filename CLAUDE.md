...
**World state wire format:** PackedByteArray quantized encoding (~196 bytes vs ~520 bytes unquantized, ~62% reduction). Skater: 33 bytes (pos s16/s8/s16 @1cm, vel 3×s16 @0.1 m/s, blade/top_hand 3×s16 @1cm each, facing u16, upper_body_rot s16 @π/32767 rad, lp_ts f32, flags u8, charge u8). Puck: 13 bytes. Goalie: 10 bytes. Encode/decode in `WorldStateCodec`; typed state objects (`SkaterNetworkState` etc.) unchanged elsewhere.
