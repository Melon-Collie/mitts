...
- **Facing and upper-body rotation interpolation:** Both fields could use Hermite interpolation for smoother remote skater movement during high-latency intervals, but this requires storing angular velocity in `SkaterNetworkState`.
