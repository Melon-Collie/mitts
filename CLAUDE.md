...
- **Pending netcode work:** `WorldStateCodec` byte-level bounds checking on malformed packets (`docs/specs/NETCODE_AUDIT_2026.md` #4); session-relative timestamps for long-session f32 precision (`docs/netcode-improvements-plan.md` #4).
